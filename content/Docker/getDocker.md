...
- Контейнер - изолированное программное пространство (Sandbox, песочница), в котором можно создавать особое программное окружение для работы приложений. Контейнер представляет собой подобие виртуальной машины. В основном в контейнерах работают различные операционные системы на базе Linux. Но Windows тоже можно установить в контейнер (Docker) Контейнеры слабо взаимодействуют в хостом (основной ОС).
